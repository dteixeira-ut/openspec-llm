...
8. **Auto-review on completion**
   ...
   Run a code review by following the steps in `openspec-review` — get the git diff, load context files, assess task coverage and code quality, and return a decision.
