---
name: "OPSX: Plan"
description: Emit an execution plan (plan.md) for an active change — PR shape, repo merge-method, named /opsx:* skill invocations per boundary, build gate, stop conditions, and rebase recipe when applicable
category: Workflow
